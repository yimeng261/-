ServerEvents.recipes(event => {
	...
	event.recipes.create.sequenced_assembly([
		...
		event.recipes.createCutting('kubejs:half_gingerMan', 'kubejs:half_gingerMan'),
		event.recipes.createDeploying('kubejs:half_gingerMan', ['kubejs:half_gingerMan', 'minecraft:cookie']),
		event.recipes.createDeploying('kubejs:half_gingerMan', ['kubejs:half_gingerMan', 'extradelight:ginger_tea']),
	]).transitionalItem('kubejs:half_gingerMan').loops(5)
